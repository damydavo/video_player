    ...
    return (
        <Container className="flex column" onMouseEnter={() => setControlShow(true)} onMouseLeave={() => setControlShow(false)}>
            ...
            <div className="wrapper">
                <div
                    className={`slider-action left ${!controlShow ? "none" : ""
                        } flex j-center a-center`}
                >
                    <AiOutlineLeft onClick={() => handleClickDirection("left")} />
                </div>
                ...
                <div
                    className={`slider-action right ${!controlShow ? "none" : ""
                        } flex j-center a-center`}
                >
                    <AiOutlineRight onClick={() => handleClickDirection("right")} />
                </div>
            </div>
